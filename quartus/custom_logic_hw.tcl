...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL avalon_master_writer_2
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file avalon_master_writer_2.vhd VHDL PATH ../rtl/comp/avalon_master_writer_2.vhd TOP_LEVEL_FILE
...
add_interface_port conduit_end user_fifo_full user_flag_1 Output 1
add_interface_port conduit_end user_rdempty user_flag_0 Output 1
add_interface_port conduit_end user_wrreq user_wrreq Input 1
add_interface_port conduit_end user_data user_data Input 32
add_interface_port conduit_end user_wrclk user_wrclk Input 1
...
add_interface_port avalon_master_1 write write Output 1
add_interface_port avalon_master_1 chipselect chipselect Output 1
add_interface_port avalon_master_1 address address Output 32
add_interface_port avalon_master_1 byteenable byteenable Output 4
add_interface_port avalon_master_1 writedata writedata Output 32
add_interface_port avalon_master_1 writeresponsevalid writeresponsevalid Input 1
add_interface_port avalon_master_1 response response Input 2
add_interface_port avalon_master_1 waitrequest waitrequest Input 1
